...
const Step = (props) => {
  ...
  return (
    <div style={props.style} className={`pm-stepper-step ${(props.done || props.active) && 'active-step'}  ${props.done && 'step-done'} ${props.editable && 'editable-step'}`}>
        <div className="pm-stepper-circle"><span>{props.step}</span></div>
